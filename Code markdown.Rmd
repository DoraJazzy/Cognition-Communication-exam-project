...
install.packages(c("rmarkdown", "knitr", "evaluate"))
```

## Setup chunk and data pre-processing
```{r general analysis, echo=TRUE, include=FALSE}
#Setup chunk
...
## Investigating the data visually and statistically - means and standard errors
```{r mean plots, echo=TRUE}
...
ggplot(mean_answer_rate3, aes(x = VVIQ, y = mean_rate, fill = VVIQ)) +
  ...
  theme_minimal() +  
  labs(
    title = "Mean Answer Rate in Emotional Immersion Questions by VVIQ Groups",
    x = "VVIQ Groups",
    y = "Mean Answer Rate"
  ) +
  scale_fill_brewer(palette = "Set2")  
